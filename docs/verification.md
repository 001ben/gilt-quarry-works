...
- Twenty-two tests cover the actual Matter.js simulation, vehicle-relative reverse and pivot turns, signed track travel, continuous chain sampling, exported blade triangle preservation and face raycasts, dense gem counts/bounds, migration from both older save formats, platform escrow/reload/completion, free-key refunds, delayed gate collision removal, full conveyor reach, and magnet strength/direction/gate boundaries.
